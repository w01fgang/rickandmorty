...
export const selectPage: (state: GlobalState) => number = createSelector(
  selectState,
  (state: GlobalState) => state.page,
);

export const selectCharacters: (state: GlobalState) => Array<Character> = createSelector(
  selectState,
  (state: GlobalState) => state.searchResults,
);
